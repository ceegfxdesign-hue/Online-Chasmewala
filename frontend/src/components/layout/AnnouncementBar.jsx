...
export function AnnouncementBar() {
  return (
    <div className="bg-navy-900 text-white">
      <div className="container-page flex h-9 items-center justify-center text-center text-xs font-medium">
        {MESSAGES.map(({ icon: Icon, text }, index) => (
          <span
            key={text}
            className={index === 0 ? 'flex items-center gap-1.5 whitespace-nowrap' : 'hidden items-center gap-1.5 whitespace-nowrap lg:ml-8 lg:flex'}
          >
