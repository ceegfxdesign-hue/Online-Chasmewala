...
export const DEFAULT_FRAME_LENS_CONFIGURATION = {
  ...
  packageCategories: [
    { id: 'bestsellers', label: 'Bestsellers', order: 0, isActive: true },
    { id: 'thin', label: 'Thin', order: 1, isActive: true },
    { id: 'screen-lenses', label: 'Screen lenses', order: 2, isActive: true },
    { id: 'premium', label: 'Premium', order: 3, isActive: true },
  ],
  packages: [
    {
      id: 'anti-glare',
