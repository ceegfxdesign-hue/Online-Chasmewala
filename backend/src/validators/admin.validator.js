import { frameLensSchema } from './frameLenses.validator.js';
import { z } from 'zod';
import {
  ORDER_STATUS,
  RETURN_STATUS,
...
export const updateSettingsSchema = {
  body: z.object({
    ...
    storeAddress: z.string().trim().min(3).max(300).optional(),
    businessHoursTitle: z.string().trim().min(2).max(80).optional(),
    businessHoursText: z.string().trim().min(2).max(300).optional(),
    ...
    navigationMenus: z
      ...
      .optional(),
    frameLensConfiguration: frameLensSchema.optional(),
  }),
};
